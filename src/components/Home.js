...
// const usertoken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6Ik9ZMTI5S0xsZ24iLCJlbWFpbCI6ImRpbGlwQGdtYWlsLmNvbSIsImlhdCI6MTcyNjU4MjIwNCwiZXhwIjoxNzI2NTg1ODA0fQ.ZaAeTTH6YYcjfbzMOZvExbjLg6IE-U2XDTkk4vcCHLc"
const usertoken= localStorage.getItem('userToken')
console.log("TOTOTTO", usertoken, typeof(usertoken), JSON.parse(usertoken), JSON.stringify(usertoken))
...
const Home = () => {
    ...
    const loginAPi = async() => {
        ...
        let config = {
            ...
            url: 'https://8b16-2405-201-d022-e983-75d2-2f72-d963-53dd.ngrok-free.app/api/all-task',
            headers: { 
                'Authorization': token
            }
        };
    ...
    const taskAPi = async (obj) => {
        ...
        let config = {
            method: 'post',
            maxBodyLength: Infinity,
            url: 'https://8b16-2405-201-d022-e983-75d2-2f72-d963-53dd.ngrok-free.app/api/task',
            headers: { 
                'Authorization':token , 
    ...
    const deleteAPi =  (id) => {
        ...
        let config = {
            method: 'delete',
            maxBodyLength: Infinity,
            url: `https://8b16-2405-201-d022-e983-75d2-2f72-d963-53dd.ngrok-free.app/api/task/${id}`,
            headers: { 
                'Authorization':token, 
                'Content-Type': 'application/json'
            },
    ...
    const deleteHandler = async (event) => {
        ...
        // dispatch({type : DELETE_TASK , payload : event.id });
        // deleteAPi(event.id)
    }
